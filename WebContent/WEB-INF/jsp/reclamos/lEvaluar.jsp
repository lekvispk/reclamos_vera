                    ...
                    <div class="col-lg-12">
                       ...
                       <jsp:include page="../include/error.jsp"/>
				   		...
				   		<form:form cssClass="form-horizontal" name="frmDocumentos" id="frmDocumentos" action="#" method="post" modelAttribute="reclamo">
							...
							<!-- Form Name -->
							<legend>Evaluar Reclamos</legend>
							<!-- Text input-->
							...
							<!-- Text input-->
							<div class="form-group">
							  <label class="col-md-4 control-label" for="txtVencimiento">F. Vencimiento</label>  
							  <div class="col-md-4">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-4">
							    ...
							    <a href="javascript:evaluar();" class="btn btn-success">Evaluar</a>
							  </div>
							</div>
						 	...
						 	<div id="resultado">
					   		...
					   		<jsp:scriptlet>
						    	...
						    	<display:table  name="requestScope.lReclamos" requestURI="lEvaluar.htm" class="displaytag" pagesize="20"
						            defaultsort="2" defaultorder="descending" sort="list" export="true" id="row" excludedParams="ajax _chk"
...
<script>
	...
	$(document).undelegate('#btnBuscar', 'click').delegate('#btnBuscar', 'click', function(){
		document.forms[0].action="lEvaluar.htm";
